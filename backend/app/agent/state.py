...
from typing import Annotated, TypedDict, Any, NotRequired, Literal
import operator


WorkerErrorCategory = Literal["input_error", "interrupted", "runtime_error"]
...
class WorkerResult(TypedDict):
    ...
    snippet: str         # 코드 스니펫
    metadata: dict[str, Any]       # worker, tool, query, errorCategory 등 부가 정보
