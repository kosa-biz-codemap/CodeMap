...
export const demoWorkspaceReport: WorkspaceReport = {
  ...
  files: [
    { path: "README.md", name: "README.md", language: "Markdown", lines: 181, bytes: 12500, kind: "source" },
    { path: "frontend/src/app/layout.tsx", name: "layout.tsx", language: "TypeScript", lines: 61, bytes: 2400, kind: "source" },
    { path: "frontend/src/app/analyze/page.tsx", name: "page.tsx", language: "TypeScript", lines: 358, bytes: 14200, kind: "source" },
    { path: "frontend/src/features/chat/components/ChatInterface.tsx", name: "ChatInterface.tsx", language: "TypeScript", lines: 310, bytes: 13500, kind: "source" },
    { path: "backend/app/main.py", name: "main.py", language: "Python", lines: 76, bytes: 3200, kind: "source" },
    { path: "backend/app/repo/router.py", name: "router.py", language: "Python", lines: 281, bytes: 9900, kind: "source" },
    { path: "backend/app/repo/pipeline/graph.py", name: "graph.py", language: "Python", lines: 163, bytes: 6500, kind: "source" },
    { path: "backend/app/chat/service.py", name: "service.py", language: "Python", lines: 140, bytes: 5800, kind: "source" },
    { path: "database/init.sql", name: "init.sql", language: "SQL", lines: 112, bytes: 4900, kind: "source" },
    { path: "frontend/src/features/chat/components/ChatInterface.test.tsx", name: "ChatInterface.test.tsx", language: "TypeScript", lines: 88, bytes: 3500, kind: "test" },
  ],
  health_score: 82,
